...
public class RoomFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        number.addTextChangedListener((Device.OnTextChangeListener) l -> {
        ...
        get.setOnClickListener((Device.OnClickListenerWithSound) l -> {
            ...
            EXECUTOR.execute(() -> {
                sleep(10_000);
                if (connection == null || resultInfo == null || get == null || number == null || !connection.connected() || !resultInfo.getText().toString().isEmpty())
                    return;
                error();
            });
        });
    ...
    private void sendRequest() {
        ...
        connection.registerListenerPacket(ResultLogin.class, packet -> {
            if (packet != null) {
                ...
                sleep(100);
                String command = String.format("[%s]-/комната", number.getText());
